...
const char* OMXCAM_dump_OMX_IMAGE_CODINGTYPE (OMX_IMAGE_CODINGTYPE imageCoding){
  switch (imageCoding){
...
void OMXCAM_dump_OMX_IMAGE_PARAM_PORTFORMATTYPE (
  ...
  printf (
      ...
      OMXCAM_dump_OMX_IMAGE_CODINGTYPE (imagePortFormat->eCompressionFormat),
      OMXCAM_dump_OMX_COLOR_FORMATTYPE (imagePortFormat->eColorFormat));
}
